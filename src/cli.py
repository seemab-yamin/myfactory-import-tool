"""CLI command parser for MyFactory Import Tool."""
...
def create_parser():
    ...
    parser.add_argument(
        "--api",
        action="store_true",
        help="Start the API server (default: launch Web UI)",
    )
    parser.add_argument(
        "--port",
        type=int,
...
def cli_schema(args):
    ...
    try:
        ...
        print("❌ 'rich' package not installed. Run: pip install rich")
        sys.exit(1)
